...
const ContactPage: React.FC = () => {
	...
	return (
		<>
			<div className='dark:bg-portfolio-grayBg bg-portfolio-antiFlashWhite'>
					...
					<form
						...
						<div className='relative md:w-2/4 w-full z-20'>
							<div className='mb-12 animate-fade-right animate-once animate-duration-1000 animate-delay-0 animate-ease-in-out'>
								<input
									className='peer p-4 block w-full dark:bg-portfolio-antiFlashWhite bg-gray-300 font-semibold text-black border-gray-200 rounded-md text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
								focus:pt-6
								focus:pb-2
							...
							<div className='mb-12 animate-fade-right animate-once animate-duration-1000 animate-delay-[600ms] animate-ease-in-out'>
								<input
									className='peer p-4 block w-full dark:bg-portfolio-antiFlashWhite bg-gray-300 text-black border-gray-200 rounded-md text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
								focus:pt-6
								focus:pb-2
								[&:not(:placeholder-shown)]:pt-6
								[&:not(:placeholder-shown)]:pb-2
							...
							<div className='mb-4 animate-fade-right animate-once animate-duration-1000 animate-delay-[900ms] animate-ease-in-out'>
								<textarea
									className='shadow appearance-none border dark:bg-portfolio-antiFlashWhite bg-gray-300 rounded-md w-full pt-2 pb-12 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline resize-none placeholder-gray-500'
									id='message'
									placeholder='Mensaje'
									name='message'
